        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-5 mb-4">
                    ...
                    <p>
                        Toko Online Aura Secret Original di Indonesia
                    </p>
                    <div class="social">
                ...
                <div class="col-md-4 mb-4">
                    ...
                    <p>
                        <i class="fa fa-map-marker"></i> Kabupaten Kediri, Jawa Timur
                    </p>
                </div>
            </div>
            <div class="row text-center mt-3 pb-3">
                <div class="col-md-12">
                    <hr>
                    © <strong>Aura Secret By Yayang Sundawa</strong> 2023 • Hak Cipta Dilindungi
                </div>
            </div>
        </div>
    </footer>
